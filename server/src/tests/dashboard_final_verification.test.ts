...
test('PeoplePay360 — Phase 6.6 Final Dashboard Verification Suite', async () => {
  ...
  try {
    ...
    await executeQuery(`
      ...
      ('${seedPrefix}EMP1', '${seedPrefix}EMP1', 'Diana', 'Prince', 'diana.p66@internal.com', 'Quantum Engineering', 'Lead Architect', '2026-01-01', 'ACTIVE'),
      ('${seedPrefix}EMP2', '${seedPrefix}EMP2', 'Clark', 'Kent', 'clark.p66@internal.com', 'Quantum Engineering', 'Staff Writer', '2026-02-01', 'ACTIVE'),
      ('${seedPrefix}EMP3', '${seedPrefix}EMP3', 'Bruce', 'Wayne', 'bruce.p66@internal.com', 'Operations', 'Director', '2026-03-01', 'ACTIVE')
    `);
